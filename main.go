...
import (
	...
	sap_api_input_reader "sap-api-integrations-cost-center-reads/SAP_API_Input_Reader"
	"sap-api-integrations-cost-center-reads/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Cost_Center_Cost_Center_Name_sample.json")
	...
	caller.AsyncGetCostCenter(
		inputSDC.CostCenter.ControllingArea,
		inputSDC.CostCenter.CostCenter,
		inputSDC.CostCenter.CostCenterText.Language,
		inputSDC.CostCenter.CostCenterText.CostCenterName,
		accepter,
	)
}
